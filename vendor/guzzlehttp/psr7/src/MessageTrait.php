...
trait MessageTrait
{
    ...
    {
        if (!$this->stream) {
            $this->stream = \_PhpScoper5f8847d7a6e47\GuzzleHttp\Psr7\Utils::streamFor('');
        }
        return $this->stream;
    }
    public function withBody(\_PhpScoper5f8847d7a6e47\Psr\Http\Message\StreamInterface $body)
    {
        if ($body === $this->stream) {
            return $this;
        }

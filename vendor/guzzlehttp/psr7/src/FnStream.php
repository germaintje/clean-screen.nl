 ...
 */
class FnStream implements \_PhpScoper5f8847d7a6e47\Psr\Http\Message\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\_PhpScoper5f8847d7a6e47\Psr\Http\Message\StreamInterface $stream, array $methods)
    {

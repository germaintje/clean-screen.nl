 ...
 */
class AppendStream implements \_PhpScoper5f8847d7a6e47\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\_PhpScoper5f8847d7a6e47\Psr\Http\Message\StreamInterface $stream)
    {
    ...
    {
        return \_PhpScoper5f8847d7a6e47\GuzzleHttp\Psr7\Utils::copyToString($this);
    }
    /**

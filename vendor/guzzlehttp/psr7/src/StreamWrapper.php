...
class StreamWrapper
{
     ...
     */
    public static function getResource(\_PhpScoper5f8847d7a6e47\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\_PhpScoper5f8847d7a6e47\Psr\Http\Message\StreamInterface $stream)
    {

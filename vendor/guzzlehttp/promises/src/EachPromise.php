 ...
 */
class EachPromise implements \_PhpScoper5f8847d7a6e47\GuzzleHttp\Promise\PromisorInterface
{
    private $pending = [];
    /** @var \Iterator|null */
    private $iterable;
    ...
    {
        $this->iterable = \_PhpScoper5f8847d7a6e47\GuzzleHttp\Promise\Create::iterFor($iterable);
    ...
    {
        $this->mutex = \false;
        $this->aggregate = new \_PhpScoper5f8847d7a6e47\GuzzleHttp\Promise\Promise(function () {
            \reset($this->pending);
            ...
            while ($promise = \current($this->pending)) {
                \next($this->pending);
                $promise->wait();
                if (\_PhpScoper5f8847d7a6e47\GuzzleHttp\Promise\Is::settled($this->aggregate)) {
                    return;
                }
            }
        });
    ...
    private function addPending()
    {
        ...
        $promise = \_PhpScoper5f8847d7a6e47\GuzzleHttp\Promise\Create::promiseFor($this->iterable->current());

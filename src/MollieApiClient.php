...
use _PhpScoper5f8847d7a6e47\Composer\CaBundle\CaBundle;
use _PhpScoper5f8847d7a6e47\GuzzleHttp\Client;
use _PhpScoper5f8847d7a6e47\GuzzleHttp\ClientInterface;
use _PhpScoper5f8847d7a6e47\GuzzleHttp\Exception\GuzzleException;
use _PhpScoper5f8847d7a6e47\GuzzleHttp\HandlerStack;
use _PhpScoper5f8847d7a6e47\GuzzleHttp\Psr7\Request;
use _PhpScoper5f8847d7a6e47\GuzzleHttp\RequestOptions as GuzzleRequestOptions;
...
class MollieApiClient
{
     ...
     */
    public function __construct(\_PhpScoper5f8847d7a6e47\GuzzleHttp\ClientInterface $httpClient = null)
    {
        $this->httpClient = $httpClient;
        if (!$this->httpClient) {
            $retryMiddlewareFactory = new \Mollie\Api\Guzzle\RetryMiddlewareFactory();
            $handlerStack = \_PhpScoper5f8847d7a6e47\GuzzleHttp\HandlerStack::create();
            $handlerStack->push($retryMiddlewareFactory->retry());
            $this->httpClient = new \_PhpScoper5f8847d7a6e47\GuzzleHttp\Client([\_PhpScoper5f8847d7a6e47\GuzzleHttp\RequestOptions::VERIFY => \_PhpScoper5f8847d7a6e47\Composer\CaBundle\CaBundle::getBundledCaBundlePath(), \_PhpScoper5f8847d7a6e47\GuzzleHttp\RequestOptions::TIMEOUT => self::TIMEOUT, \_PhpScoper5f8847d7a6e47\GuzzleHttp\RequestOptions::CONNECT_TIMEOUT => self::CONNECT_TIMEOUT, 'handler' => $handlerStack]);
        }
        ...
        if (\defined('\\GuzzleHttp\\ClientInterface::MAJOR_VERSION')) {
            // Guzzle 7
            $this->addVersionString("Guzzle/" . \_PhpScoper5f8847d7a6e47\GuzzleHttp\ClientInterface::MAJOR_VERSION);
        } elseif (\defined('\\GuzzleHttp\\ClientInterface::VERSION')) {
            // Before Guzzle 7
            $this->addVersionString("Guzzle/" . \_PhpScoper5f8847d7a6e47\GuzzleHttp\ClientInterface::VERSION);
        }
    }
    ...
    public function performHttpCallToFullUrl($httpMethod, $url, $httpBody = null)
    {
        ...
        $request = new \_PhpScoper5f8847d7a6e47\GuzzleHttp\Psr7\Request($httpMethod, $url, $headers, $httpBody);
        try {
            $response = $this->httpClient->send($request, ['http_errors' => \false]);
        } catch (\_PhpScoper5f8847d7a6e47\GuzzleHttp\Exception\GuzzleException $e) {
     ...
     * @throws ApiException
     */
    private function parseResponseBody(\_PhpScoper5f8847d7a6e47\Psr\Http\Message\ResponseInterface $response)
    {
